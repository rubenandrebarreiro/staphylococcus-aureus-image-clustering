...
def plot_stacked_histograms(data_frame_transformed_extraction, method, num_components = 6, alpha_value = 0.8):
    ...
    py_plot.savefig( '{}-with-{}-components-data-stacked-histograms-alpha-{}.png'.format(method.lower(), num_components, alpha_value), dpi = 600, bbox_inches = 'tight' )
...
def plot_individual_histograms(data_frame_transformed_extraction, method, num_components = 6, alpha_value = 0.8):
    ...
    # Save the Plot, as a figure/image
    py_plot.savefig( '{}-with-{}-components-data-individual-histograms-alpha-{}.png'.format(method.lower(), num_components, alpha_value), dpi = 600, bbox_inches = 'tight' )
...
def plot_box(data_frame_transformed_extraction, method, num_components = 6):
    ...
    # Save the Plot, as a figure/image
    py_plot.savefig( '{}-with-{}-components-data-box.png'.format(method.lower(), num_components), dpi = 600, bbox_inches = 'tight' )
...
def plot_scatter_matrix_param_diagonal(data_frame_transformed_extraction, method, diagonal_plot, num_components = 6, alpha_value = 0.8):
    ...
    # Save the Plot, as a figure/image
    py_plot.savefig('{}-with-{}-components-data-scatter-matrix-{}-diagonal-alpha-{}.png'.format(method.lower(), num_components, diagonal_plot, alpha_value), dpi = 600, bbox_inches = 'tight' )
...
def plot_parallel_coordinates(data_frame_transformed_extraction, method, num_components = 6):
    ...
    # Save the Plot, as a figure/image
    py_plot.savefig( '{}-with-{}-components-data-parallel-coordinates.png'.format(method.lower(), num_components), dpi = 600, bbox_inches = 'tight' )
...
def plot_andrews_curves(data_frame_transformed_extraction, method, num_components = 6):
    ...
    # Save the Plot, as a figure/image
    py_plot.savefig( '{}-with-{}-components-data-andrew-curves.png'.format(method.lower(), num_components), dpi = 600, bbox_inches = 'tight' )
...
def plot_elbow_method(clustering_algorithm, squared_errors_sums_intertias, best_num_clusters, num_max_clusters = 12):
    ...
    # Save the Plot, as a figure/image
    py_plot.savefig( '{}-clustering-elbow-method-for-max-of-{}-clusters.png'.format(clustering_algorithm.lower(), num_max_clusters), dpi = 600, bbox_inches = 'tight' )
...
def plot_k_distance_method(clustering_algorithm, num_data_points_sorted_by_distance, k_neighbors_distances_epsilons, best_distance_epsilon):
    ...
    # Save the Plot, as a figure/image
    py_plot.savefig( '{}-clustering-k-distance-method.png'.format(clustering_algorithm.lower()), dpi = 600, bbox_inches = 'tight' )
    ...
    if( ( num_clusters > 0 ) and ( num_clusters <= 26 ) ):
        ...
        if(final_clustering):
            ...
            if( ( clustering_algorithm == "DBSCAN" ) and ( epsilon != None ) ):
                ...
                # Save the Plot, as a figure/image
                py_plot.savefig( 'final-{}-clustering-centroids/final-{}-clustering-for-{}-clusters-centroids-and-epsilon-{}.png'.format(clustering_algorithm.lower(), clustering_algorithm.lower(), num_clusters, epsilon), dpi = 600, bbox_inches = 'tight' )
                ...
                # Save the Plot, as a figure/image
                py_plot.savefig( 'final-{}-clustering-for-{}-clusters-centroids-and-damping-{}.png'.format(clustering_algorithm.lower(), num_clusters, damping), dpi = 600, bbox_inches = 'tight' )
                ...
                # Save the Plot, as a figure/image
                py_plot.savefig( 'final-{}-clustering-for-{}-clusters-centroids.png'.format(clustering_algorithm.lower(), num_clusters), dpi = 600, bbox_inches = 'tight' )
        ...
        # with the a certain K for the number of Clusters
            ...
            if( ( clustering_algorithm == "DBSCAN" ) and ( epsilon != None ) ):
                ...
                # Save the Plot, as a figure/image
                py_plot.savefig( 'pre-{}-clustering-for-{}-clusters-centroids-and-epsilon-{}.png'.format(clustering_algorithm.lower(), num_clusters, epsilon), dpi = 600, bbox_inches = 'tight' )
                ...
                # Save the Plot, as a figure/image
                py_plot.savefig( 'pre-{}-clustering-for-{}-clusters-centroids-and-damping-{}.png'.format(clustering_algorithm.lower(), num_clusters, damping), dpi = 600, bbox_inches = 'tight' )
                ...
                # Save the Plot, as a figure/image
                py_plot.savefig( 'pre-{}-clustering-for-{}-clusters-centroids.png'.format(clustering_algorithm.lower(), num_clusters), dpi = 600, bbox_inches = 'tight' )
...
def plot_silhouette_analysis(clustering_algorithm, xs_features_data, ys_labels_predicted, estimator_centroids, num_clusters, epsilon = None, damping = None, final_clustering = False):
    ...
    if(final_clustering):
        ...
        if( ( clustering_algorithm == "DBSCAN" ) and ( epsilon != None ) ):
            ...
            # Save the Plot, as a figure/image
            py_plot.savefig( 'final-{}-clustering-silhouette-analysis-for-{}-clusters-centroid-and-epsilon-{}.png'.format(clustering_algorithm.lower(), num_clusters, epsilon), dpi = 600, bbox_inches = 'tight' )
            ...
            # Save the Plot, as a figure/image
            py_plot.savefig( 'final-{}-clustering-silhouette-analysis-for-{}-clusters-centroid-and-damping-{}.png'.format(clustering_algorithm.lower(), num_clusters, damping), dpi = 600, bbox_inches = 'tight' )
            ...
            # Save the Plot, as a figure/image
            py_plot.savefig( 'final-{}-clustering-silhouette-analysis-for-{}-clusters-centroids.png'.format(clustering_algorithm.lower(), num_clusters), dpi = 600, bbox_inches = 'tight' )
        ...
        if( ( clustering_algorithm == "DBSCAN" ) and ( epsilon != None ) ):
            ...
            # Save the Plot, as a figure/image
            py_plot.savefig( 'pre-{}-clustering-silhouette-analysis-for-{}-clusters-centroids-and-epsilon-{}.png'.format(clustering_algorithm.lower(), num_clusters, epsilon), dpi = 600, bbox_inches = 'tight' )
            ...
            # Save the Plot, as a figure/image
            py_plot.savefig( 'pre-{}-clustering-silhouette-analysis-for-{}-clusters-centroids-and-damping-{}.png'.format(clustering_algorithm.lower(), num_clusters, damping), dpi = 600, bbox_inches = 'tight' )
            ...
            # Save the Plot, as a figure/image
            py_plot.savefig( 'pre-{}-clustering-silhouette-analysis-for-{}-clusters-centroids.png'.format(clustering_algorithm.lower(), num_clusters), dpi = 600, bbox_inches = 'tight' )
...
def plot_confusion_matrix_rand_index_clustering_heatmap(clustering_algorithm, confusion_matrix_rand_index_clustering, num_clusters, epsilon = None, damping = None, final_clustering = False):
    ...
    if(final_clustering):
        ...
        if( ( clustering_algorithm == "DBSCAN" ) and ( epsilon != None ) ):
            ...
            # Save the Plot, as a figure/image
            py_plot.savefig( 'final-{}-clustering-heatmap-for-{}-clusters-centroids-and-epsilon-{}.png'.format(clustering_algorithm.lower(), num_clusters, epsilon), dpi = 600, bbox_inches = 'tight' )
            ...
            # Save the Plot, as a figure/image
            py_plot.savefig( 'final-{}-clustering-heatmap-for-{}-clusters-centroids-and-damping-{}.png'.format(clustering_algorithm.lower(), num_clusters, damping), dpi = 600, bbox_inches = 'tight' )
            ...
            # Save the Plot, as a figure/image
            py_plot.savefig( 'final-{}-clustering-heatmap-for-{}-clusters-centroids.png'.format(clustering_algorithm.lower(), num_clusters), dpi = 600, bbox_inches = 'tight' )
        ...
        if( ( clustering_algorithm == "DBSCAN" ) and ( epsilon != None ) ):
            ...
            # Save the Plot, as a figure/image
            py_plot.savefig( 'pre-{}-clustering-heatmap-for-{}-clusters-centroids-and-epsilon-{}.png'.format(clustering_algorithm.lower(), num_clusters, epsilon), dpi = 600, bbox_inches = 'tight' )
        ...
        if( ( clustering_algorithm == "Affinity-Propagation" ) and ( damping != None ) ):
            ...
            # Save the Plot, as a figure/image
            py_plot.savefig( 'pre-{}-clustering-heatmap-for-{}-clusters-centroids-and-damping-{}.png'.format(clustering_algorithm.lower(), num_clusters, damping), dpi = 600, bbox_inches = 'tight' )
            ...
            # Save the Plot, as a figure/image
            py_plot.savefig( 'pre-{}-clustering-heatmap-for-{}-clusters-centroids.png'.format(clustering_algorithm.lower(), num_clusters), dpi = 600, bbox_inches = 'tight' )
...
def plot_clustering_scores(clustering_algorithm, num_total_clusters, start_epsilon, end_epsilon, step_epsilon, epsilon_values, start_damping, end_damping, step_damping, damping_values, clusters_silhouette_scores, clusters_precision_scores, clusters_recall_scores, clusters_rand_index_scores, clusters_f1_scores, clusters_adjusted_rand_scores):
    ...
    if(clustering_algorithm == "DBSCAN"):
        ...
        # Save the Plot, as a figure/image
        py_plot.savefig( '{}-clustering-performance-metrics-scores-for-max-of-epsilon-value-of-{}.png'.format(clustering_algorithm.lower(), end_epsilon), dpi = 600, bbox_inches = 'tight' )

    elif(clustering_algorithm == "Affinity-Propagation"):
        
        # Save the Plot, as a figure/image
        py_plot.savefig( '{}-clustering-performance-metrics-scores-for-max-of-damping-value-of-{}.png'.format(clustering_algorithm.lower(), end_damping), dpi = 600, bbox_inches = 'tight' )
                
    else:
        
        # Save the Plot, as a figure/image
        py_plot.savefig( '{}-clustering-performance-metrics-scores-for-max-of-{}-clusters.png'.format(clustering_algorithm.lower(), num_total_clusters), dpi = 600, bbox_inches = 'tight' )
